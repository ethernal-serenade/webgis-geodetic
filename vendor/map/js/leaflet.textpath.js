...
(function () {
    ...
    var PolylineTextPath = {
        ...
        setText: function (text, options) {
            ...
            /* If not in SVG mode or Polyline not added to pages yet return */
            ...
            if (!text) {
                if (this._textNode && this._textNode.parentNode) {
                    ...
                    /* delete the node, so it will not be removed a 2nd time if the layer is later removed from the pages */
