! function($) {
    ...
    function sideNavToggle() { $(".side-nav-toggle").on("click", function(e) { $(".app").toggleClass("is-collapsed"), e.preventDefault() }) }
    ...
    function themeColorConfig() { $(".header-default input").change(function() { $(".app").removeClass("header-primary header-info header-success header-danger header-dark") }), $(".header-info input").change(function() { $(".app").addClass("header-info"), $(".app").removeClass("header-primary header-success header-danger header-dark") }), $(".header-primary input").change(function() { $(".app").addClass("header-primary"), $(".app").removeClass("header-info header-success header-danger header-dark") }), $(".header-success input").change(function() { $(".app").addClass("header-success"), $(".app").removeClass("header-info header-primary header-danger header-dark") }), $(".header-danger input").change(function() { $(".app").addClass("header-danger"), $(".app").removeClass("header-info header-primary header-success header-dark") }), $(".header-dark input").change(function() { $(".app").addClass("header-dark"), $(".app").removeClass("header-info header-primary header-success header-danger") }), $(".theme-colors.side-nav-dark input").change(function() { $(".app").addClass("side-nav-dark"), $(".app").removeClass("side-nav-default") }), $(".theme-colors.sidenav-default input").change(function() { $(".app").addClass("side-nav-default"), $(".app").removeClass("side-nav-dark") }), $("#rtl-toogle").on("click", function(e) { $(".app").toggleClass("rtl"), e.preventDefault() }) }! function() { sideNav(), sideNavToggle(), sidePanelToggle(), chatToggle(), todoToggle(), searchToggle(), advanceSearch(), themeConfig(), perfectSB(), cardPortletCtrl(), themeColorConfig() }()
}(jQuery);