...
$.ajax({
    ...
    success: function(data) {
        groupedOverlays["<span class='text-center text-primary font-size-16'>LỚP DỮ LIỆU</span>"] = {}
        data.forEach(function(layer) {
            ...
            groupedOverlays["<span class='text-center text-primary font-size-16'>LỚP DỮ LIỆU</span>"]
                ["<span class='font-size-16'>" + layer.layer_name + "</span>"] = layer_in_map
        })
    }
})
...
var checkEmptyValue = isEmptyValue(groupedOverlays["<span class='text-center text-primary font-size-16'>LỚP DỮ LIỆU</span>"])
if (checkEmptyValue !== true) {
