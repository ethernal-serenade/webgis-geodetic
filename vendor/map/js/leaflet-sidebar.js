 ...
 * @param {string} [options.autopan=false] - whether to move the pages when opening the sidebar to make maintain the visible center point
...
L.Control.Sidebar = L.Control.extend( /** @lends L.Control.Sidebar.prototype */ {
    ...
    /**
     * Add this sidebar to the specified pages.
     *
     * @param {L.Map} map
     * @returns {Sidebar}
     */
    ...
    /**
     * Remove this sidebar from the pages.
     *
     * @param {L.Map} map
     * @returns {Sidebar}
     */
     ...
     * Adds the control to the given pages. Overrides the implementation of L.Control,
     * changing the DOM mount target from pages._controlContainer.topleft to pages._container
     */
    addTo: function (map) {
        this.onRemove();
        this._map = map;
        ...
        // when adding to the pages container, we should stop event propagation
        L.DomEvent.disableScrollPropagation(this._container);
        L.DomEvent.disableClickPropagation(this._container);
        L.DomEvent.on(this._container, 'contextmenu', L.DomEvent.stopPropagation);

        // insert as first child of pages container (important for css)
     ...
     * Removes this sidebar from the pages.
     * @param {L.Map} map
     * @returns {Sidebar}
     */
    ...
    addPanel: function (data) {
        ...
        // Register click listeners, if the sidebar is on the pages
    ...
    /**
     * Helper for autopan: Pans the pages for open/close events
     *
 ...
 *
 * @example
 * var sidebar = L.control.sidebar({ container: 'sidebar' }).addTo(pages);
 *
 * @param {Object} [options] - Optional options object
 * @param {string} [options.autopan=false] - whether to move the pages when opening the sidebar to make maintain the visible center point
 * @param {string} [options.position=left] - Position of the sidebar: 'left' or 'right'
