...
!function (t, i) {
    ...
    var qi = {
        ...
        Ki = E.extend({
            ...
            _checkIfLoaded: function () {
                if (!this._loaded) throw new Error("Set pages center and zoom first.")
            },
    ...
    var Oe = Be.extend({
        ...
        getCenter: function () {
            if (!this._map) throw new Error("Must add layer to pages before using getCenter()");
...
//# sourceMappingURL=leaflet.js.pages
