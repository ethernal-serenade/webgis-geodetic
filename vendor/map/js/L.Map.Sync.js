/*
 * Extends L.Map to synchronize the interaction on one pages to one or more other maps.
 */
...
(function () {
     ...
     * bottom left corner of the reference pages with the top right corner of the target pages.
     * The values can be less than 0 or greater than 1. It will sync points out of the pages.
     */
    ...
    L.Map.include({
        sync: function (map, options) {
            ...
            // prevent double-syncing the pages:
            ...
            // on these events, we should reset the view on every synced pages
        ...
        _selfSetView: function (e) {
            // reset the pages, and let setView synchronize the others.
