...
L.Google = (L.Layer || L.Class).extend({
    ...
    onAdd: function (map, insertAtTheBottom) {
        ...
        //pages._controlCorners['bottomright'].style.marginBottom = "20px";
    ...
    onRemove: function (map) {
        ...
        //pages._controlCorners['bottomright'].style.marginBottom = "0em";
        if (map.options.attributionControl && map.attributionControl) {
    ...
    _initMapObject: function () {
        ...
        var _this = this;
        // this._reposition = google.maps.event.addListenerOnce(pages, "center_changed",
        // 	function() {
        // 		_this.onReposition();
        // 	});
        this._google = map;
    ...
    _checkZoomLevels: function () {
        //setting the zoom level on the Google pages may result in a different zoom level than the one requested
